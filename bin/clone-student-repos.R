...
#' Get team
#'
#' Get infor for the GitHub team named \code{team} in organization \code{org}.
#'
...
#'
#' @param teamname string. Name of the GitHub team
#' @param org string. Name of the GitHub organization.
#'
...
#' @returns
#'
download_all_repos <- function(org, team, path = ".", use_ssh = TRUE) {
  ...
  out <- set_names(rep(NA_character_, length(urls)), urls)
