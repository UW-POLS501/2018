...
3. Click on the *Fork* button to fork the repository to your Github account.</li>
...
9.  Paste the URL that you copied into the field *Repository URL*, choose a name for the folder in which the project will be saved in the field *Project Directory Name*, and select the subdirectory
...
4. **Push** changes to their respository, `UW-POLS501/assignment-1`
