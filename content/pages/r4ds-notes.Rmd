...
as.tibble(d)$foo
```
Additionally, `[[` doesn't partially match:
```{r}
d[["foo"]]
```
...
Replication datatsets and datasets used in analysis are often non-tidy. Why?
...
- What are set union, interection, complement, and difference? 
